...
public class BuilderCfg {
    ...
    private final static String BUILDER_PRE = "com.power.generator.builder.";
    public final static String MODEL_BUILER = BUILDER_PRE + "ModelBuilder";
    public final static String DAO_BUILER = BUILDER_PRE + "DaoBuilder";
    public final static String MAPPER_BUILDER = BUILDER_PRE + "MapperBuilder";
