...
public class OkHttp3Util {
     ...
     * @param headersMap request headers
     */
    public static InputStream download(String baseUrl, Map<String, String> params, Map<String, String> headersMap) {
        OkHttpClient client = OkHttp3Util.getInstance();
        return doDownload(client, baseUrl, params, headersMap);
    }
     ...
     * @param headersMap request headers
     */
    public static InputStream download(OkHttpClient client, String baseUrl, Map<String, String> params, Map<String, String> headersMap) {
        return doDownload(client, baseUrl, params, headersMap);
    }
    ...
    private static InputStream doDownload(OkHttpClient client, String baseUrl, Map<String, String> params, Map<String, String> headersMap) {
        String url = UrlUtil.urlJoin(baseUrl, params);
        LOGGER.debug("Sync download by Get Request url: {}", url);
        long startTime = System.currentTimeMillis();
        Call call = initCall(client, url, headersMap);
        try {
            Response response = call.execute();
            LOGGER.debug("Sync download Cost time:", (System.currentTimeMillis() - startTime));
    ...
    private static class SingletonHolder {
        ...
        private static final OkHttpClient INSTANCE = new OkHttpClient.Builder()
                ...
                .sslSocketFactory(Objects.requireNonNull(SSLSocketFactoryBuilder.getSslSocketFactory()), new TrustAnyTrustManager())
                .build();
    }
}
